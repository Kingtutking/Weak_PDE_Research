...
class WeakPDELibrary(BaseFeatureLibrary):
    ...
    spatiotemporal_grid : np.ndarray (default None)
        ...
        ## Grid needs to be the same length as the data points
    ...
    def __init__(
        ...
        # list of integrals
        indices = ()
        ## Turn the spatiotemporal grid into array. If spatiotemporal grid 
        ## is 1d, turn it into n by 1 matrix where n is the length of your 
        ## 1d array.
