...
#       for theta_nonloc_p calculation
    ...
    def _set_up_weights(self):
        ...
        ## we added the H_xt back. Functionally, why do we need to enforce such constraint?
        ##We do not need an uniform grid
        
        ## Indecies of each of the subdomains i.e. self.K = 100
        
        ## Create a subspace based on the data points
        ## Create domain center
        ## Length of the spatialtemporal grid point
        ...
        ## Index is the list of starting (and the onverlapping ending) points. 
